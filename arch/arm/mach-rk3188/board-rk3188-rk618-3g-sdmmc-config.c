...
int rk31sdk_get_sdio_wifi_voltage(void)
{
    ...
    ******************************************************************************/
#if defined(CONFIG_BCM4330) || defined(CONFIG_BCM4329) || defined(CONFIG_BCM4319) || defined(CONFIG_RK903) || defined(CONFIG_RK901) || defined(CONFIG_RKWIFI)
    voltage = 2800 ; //power 1800mV
