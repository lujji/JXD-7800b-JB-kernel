...
static struct batt_vol_cal  batt_table[] = {
	{0,3450,3770},{1,3480,3800},{2,3510,3820},{3,3540,3840},{4,3560,3850},{5,3580,3860},
	{6,3600,3870},{7,3610,3880},{8,3620,3890},{9,3630,3900},{10,3640,3910},
	{11,3650,3920},{13,3660,3925},{15,3670,3935},{17,3680,3945},{19,3690,3955},
	{21,3700,3965},{23,3710,3975},{25,3720,3985},{27,3730,3995},{29,3740,4005},
	{31,3750,4015},{34,3760,4025},{37,3770,4035},{40,3780,4045},{43,3790,4055},
	{46,3800,4065},{49,3810,4075},{52,3820,4080},{55,3830,4090},{58,3840,4100},
	{61,3850,4110},{64,3860,4120},{67,3870,4130},{70,3880,4140},{73,3890,4150},
	{76,3900,4160},{79,3910,4163},{82,3920,4165},{85,3930,4167},{88,3940,4170},
	{91,3950,4172},{93,3960,4174},{95,3970,4176},{97,3980,4178},{99,3990,4179},{100,4000,4180},
};
#else
...
static void rk30_adc_battery_voltage_samples(struct rk30_adc_battery_data *bat)
{
	...
	*pSamples++ = rk_adc_voltage(value);
	...
	if(1 == level){
		...
		else if(bat->bat_voltage <= batt_table[0].charge_vol  - 5)
